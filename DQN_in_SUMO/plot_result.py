...
training_date = "2023.05.08-10.25.19"
...
ax1 = plt.plot(episodes, average_reward, c="#214c41", alpha=0.3)
ax2 = plt.plot(episodes, smoothing_average(average_reward, 0.6), c="#214c41")
